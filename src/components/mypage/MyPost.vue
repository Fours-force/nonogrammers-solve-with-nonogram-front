<template>
	<h1
		class="w-full pb-5 pl-5 text-3xl border-b-2 mb-7 font-brr text-nav-navy"
	>
		작성한 글
	</h1>

	<article
		class="flex flex-col w-full bg-white border-t-2 rounded-lg border-x-2 lg:w-12/12"
	>
		...
		<div
			class="relative w-full overflow-x-auto shadow-md sm:rounded-lg sm:min-w-full"
		>
			<div class="table w-full overflow-hidden text-left text-md">
				...
				>
					...
					<div
						class="hidden w-3/6 px-6 py-3 sm:hidden md:hidden lg:table-cell"
					>
						본문
					</div>
					<div class="px-6 py-3">
				...
				<div class="table-row-group min-w-full">
					...
					>
						...
						>
							...
							<div
								class="hidden px-6 py-4 text-sm text-gray-500 sm:hidden md:hidden lg:table-cell"
							>
							...
							<div class="table-cell px-6 py-4 text-right">
								<button
									...
									data-th-attr="data-modal-target='modal'+${postStat.count}, data-modal-toggle='modal'+${postStat.count}"
								>
									Edit
								</button>
									...
									<div class="p-6 space-y-3">
										...
										>
											<button
												...
												data-th-attr="data-modal-hide='modal'+${postStat.count}"
											>
												<svg
													class="w-3 h-3"
													aria-hidden="true"
										...
										>
											...
											>
												...
												<label
													for="title"
													class="peer-focus:font-medium absolute text-xl text-gray-500 transform -translate-y-6 scale-75 top-1 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
													>제목</label
												>
												<input
													name="title"
													type="text"
													id="title"
													class="block py-2.5 px-0 w-full text-xl text-gray-900 bg-transparent border-0 border-b-2 mb-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
												...
												<textarea
													...
													id="content"
													rows="5"
													class="block p-2.5 w-full text-md text-gray-800 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
